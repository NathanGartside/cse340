...
*   Register new car
* *************************** */
async function newInventory(inv_make, inv_model, inv_year, inv_description, inv_image, inv_thumbnail, inv_price, inv_miles, inv_color, classification_id){
  try {
...
module.exports = {getClassifications, getInventoryByClassificationId, getInventoryByCarId, newClassification, newInventory, updateInventory}